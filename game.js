...
function getPieceFromChar(char, game) {
	switch (char) {
		case "♜":
			return new Rook("R", false, game);

		case "♞":
			return new Knight("N", false, game);

		case "♝":
			return new Bishop("B", false, game);

		case "♚":
			return new King("K", false, game);

		case "♛":
			return new Queen("Q", false, game);

		case "♟":
			return new Pawn("p", false, game);

		case "♖":
			return new Rook("R", true, game);

		case "♘":
			return new Knight("N", true, game);

		case "♗":
			return new Bishop("B", true, game);

		case "♔":
			return new King("K", true, game);

		case "♕":
			return new Queen("Q", true, game);

		case "♙":
			return new Pawn("p", true, game);
